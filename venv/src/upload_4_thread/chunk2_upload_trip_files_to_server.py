...
#   Batch process on V2
    log = upload_bin_batch_v2('/home/ec2-user/yichuan_testing/upload_in_4_chunk/Apr_weekly_data_chunked/chunk2', 'http://localhost:8080/api/v2/drivers')
    log_dataframe = pd.DataFrame(log)
    log_dataframe.to_csv("/home/ec2-user/yichuan_testing/upload_in_4_chunk/tripid_chunk2.csv", index = False)
